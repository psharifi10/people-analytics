...
select
    ...
    {{ json_field_cast('raw_payload', 'opened_at', 'date') }}             as opened_at,
    {{ json_field_try_cast('raw_payload', 'closed_at', 'date') }}         as closed_at,
    {{ json_field('raw_payload', 'status') }}                             as status,
    {{ json_field('raw_payload', 'hired_worker_ids') }}                   as hired_worker_ids_json,
