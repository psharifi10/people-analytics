...
select
    ...
    {{ json_field_cast('raw_payload', 'extended_at', 'timestamp') }}           as extended_at,
    {{ json_field_try_cast('raw_payload', 'responded_at', 'timestamp') }}      as responded_at,
    {{ json_field('raw_payload', 'status') }}                                  as status,
    {{ json_field_try_cast('raw_payload', 'base_salary_amount', 'double') }}   as base_salary_amount,
    {{ json_field('raw_payload', 'base_salary_currency') }}                    as base_salary_currency,
    {{ json_field('raw_payload', 'accepted_person_external_id') }}             as accepted_person_external_id,
